export type SupplementCategory = 'Minerals' | 'Amino Acids' | 'Herbal' | 'Vitamins' | 'Antioxidants' | 'Probiotics' | 'Adaptogens' | 'Protein' | 'Gut Healing';
...
export const SUPPLEMENTS_DB: SupplementData[] = [
  ...
  },
  {
    ...
    tagline: 'Natural Testosterone Booster',
    category: 'Adaptogens',
    dosage: '200-400mg (standardized to 2% Eurycomanone)',
    timing: 'AM',
    description:
      'Tongkat Ali is a Southeast Asian medicinal herb with centuries of traditional use as a vitality tonic and male fertility enhancer. The active compound, Eurycomanone, has been shown in clinical studies to increase free testosterone levels by reducing sex hormone-binding globulin (SHBG), which binds testosterone and renders it inactive. This is particularly relevant for substance recovery because chronic stimulant and alcohol use suppress testosterone production through multiple pathways: HPA axis dysregulation, testicular oxidative damage, and elevated cortisol which directly antagonizes testosterone synthesis. Tongkat Ali also supports cortisol reduction, making it a dual-action hormone optimizer.',
    mechanism:
      'Eurycomanone (primary active compound) inhibits SHBG production, increasing free (bioavailable) testosterone. Stimulates the release of free testosterone from its binding proteins. Modulates the hypothalamic-pituitary-gonadal (HPG) axis. Reduces cortisol via 11β-HSD1 enzyme inhibition, lowering the cortisol-to-testosterone ratio. Enhances mitochondrial energy production through ATP synthase activation. Supports Leydig cell function in the testes.',
    benefits: [
      'Boosts free testosterone naturally without exogenous hormones',
      'Fights fatigue and enhances mitochondrial energy production',
      'Reduces cortisol, the stress hormone that suppresses testosterone',
      'Supports muscle recovery and lean body mass',
      'Improves libido and sexual function',
      'Enhances mood and reduces stress-related anxiety',
      'Improves physical performance and endurance',
      'Supports sperm quality and male fertility',
    ],
    cautions: [
      'Start with 200mg and increase gradually to assess tolerance',
      'Cycle 4 weeks on, 1 week off to prevent receptor desensitization',
      'Avoid with thyroid medications — may interfere with thyroid function',
      'May increase body temperature slightly (thermogenic effect)',
  ...
  {
    id: 'shilajit',
    name: 'Shilajit (Fulvic Acid)',
    shortName: 'Shilajit',
    tagline: 'Mineral Rejuvenator',
    category: 'Minerals',
    dosage: '250-500mg (standardized to 60-70% fulvic acid)',
    timing: 'AM',
    description:
      'Shilajit is a natural tar-like substance found primarily in the Himalayan mountains, formed over centuries from the slow decomposition of plant matter. It is one of the most mineral-dense substances on earth, containing over 85 minerals in ionic form along with fulvic acid, humic acid, and dibenzo pyrones. Shilajit has been used in Ayurvedic medicine for over 3,000 years as a rejuvenator (rasayana). Modern research confirms its ability to enhance mitochondrial function by stimulating CoQ10 and ATP production, making it particularly valuable for recovery from substance-induced mitochondrial damage. It also supports testosterone production and cognitive function.',
    mechanism:
      'Fulvic acid (primary bioactive) enhances mitochondrial electron transport chain efficiency, directly boosting ATP (cellular energy) production. Chelates and delivers 85+ trace minerals directly into cells. Stimulates CoQ10 synthesis and protects CoQ10 from degradation. Enhances testosterone production via luteinizing hormone (LH) stimulation. Dibenzo pyrones protect mitochondrial DNA from oxidative damage. Activates Nrf2 antioxidant pathway.',
    benefits: [
      'Enhances mitochondrial energy production — directly repairs substance-induced energy deficits',
      'Boosts testosterone levels and supports hormonal balance',
      'Rich in 85+ minerals including rare trace elements',
      'Supports cognitive function and memory',
      'Reduces oxidative stress and protects cellular structures',
      'Enhances CoQ10 efficacy for cardiovascular and mitochondrial health',
      'Improves iron metabolism and reduces fatigue',
      'Potent adaptogen — helps the body resist physical and mental stress',
    ],
    cautions: [
      'Start with 250mg and increase to 500mg over 1-2 weeks',
      'Quality varies greatly — choose purified, lab-tested products only',
      'Dissolve in warm water or milk for best absorption',
      'May have a strong taste and smell — capsule form recommended for sensitive individuals',
      'Avoid raw/unpurified shilajit — may contain heavy metal contaminants',
    ],
    forSubstances: ['methamphetamine', 'mdma'],
    stackNotes:
  ...
  },
  {
    ...
    tagline: 'Complete Protein Foundation',
    category: 'Protein',
    dosage: '20-40g per serving',
    timing: 'AM',
    description:
      'Whey protein is a complete, high-quality protein derived from milk that contains all nine essential amino acids in optimal ratios for human absorption. It has the highest biological value (BV) of any protein source, meaning the body utilizes it more efficiently than other proteins. For substance recovery, whey protein is foundational because chronic substance use causes severe protein malnutrition through poor diet, impaired digestion, and increased catabolism. Whey protein directly stimulates muscle protein synthesis via mTOR pathway activation, provides precursors for neurotransmitter synthesis (tyrosine, tryptophan, phenylalanine), and has been shown to increase testosterone and reduce cortisol levels.',
    mechanism:
      'Rich in branched-chain amino acids (BCAAs) — leucine directly activates mTORC1 pathway, stimulating muscle protein synthesis. Provides L-tyrosine (dopamine precursor) and L-tryptophan (serotonin precursor) for neurotransmitter production. Contains bioactive peptides (lactoferrin, immunoglobulins) that support immune function. Increases glutathione via cysteine-rich fractions. Whey protein isolate form eliminates lactose for sensitive individuals.',
    benefits: [
      'Provides all essential amino acids in optimal ratios for recovery',
      'Stimulates muscle protein synthesis via mTOR pathway activation',
      'Increases testosterone levels and reduces cortisol post-workout',
      'Improves strength, power, and physical performance',
      'Supports immune function with bioactive peptides (lactoferrin, immunoglobulins)',
      'Accelerates recovery from physical damage and inflammation',
      'Provides neurotransmitter precursors (tyrosine, tryptophan)',
      'Cost-effective and convenient nutrition for malnourished users',
    ],
    cautions: [
      'Start with 20g and assess tolerance — some experience bloating initially',
      'Choose whey protein isolate if lactose intolerant (isolate has <1% lactose)',
      'Best consumed within 30-60 minutes post-workout for optimal muscle protein synthesis',
      'Not a meal replacement — should supplement a balanced diet',
      'Excessive protein (>2g per kg body weight) without adequate water stresses kidneys',
    ],
    forSubstances: ['methamphetamine', 'mdma', 'cannabis'],
    stackNotes:
  ...
  },
  {
    ...
    shortName: 'Creatine',
    tagline: 'Brain + Muscle Shield',
    category: 'Protein',
    dosage: '3-5g daily',
    timing: 'Any',
    description:
      'Creatine monohydrate is the most extensively researched sports supplement in history, with over 500 peer-reviewed studies confirming its safety and efficacy. Beyond its well-known benefits for muscle strength and power, creatine has recently emerged as a powerful neuroprotective agent for brain recovery. Chronic substance use damages mitochondrial function and depletes cellular energy (ATP) in both muscles and brain cells. Creatine directly replenishes phosphocreatine stores, the cell\'s rapid energy buffer system, allowing neurons to maintain ionic gradients and resist excitotoxic damage. Research shows creatine supplementation improves cognitive function, reduces mental fatigue, and may help repair traumatic brain injury.',
    mechanism:
      'Replenishes phosphocreatine (PCr) stores in muscle and brain tissue. PCr donates a phosphate group to ADP to rapidly regenerate ATP during high-energy demand. Enhances mitochondrial respiration and reduces reactive oxygen species (ROS) production. Supports brain energy metabolism — creatine kinase is highly expressed in neurons. Increases cell hydration (osmotic effect) which activates anabolic signaling. Reduces homocysteine levels, supporting cardiovascular and cognitive health.',
    benefits: [
      'Repairs mitochondrial dysfunction in both brain and muscle cells',
      'Improves cognitive recovery, reduces mental fatigue and brain fog',
      'Increases muscle strength, power, and lean body mass',
      'Enhances cellular energy (ATP) production across all tissues',
      'Reduces muscle damage and inflammation after exercise',
      'Improves cell hydration and nutrient delivery',
      'May have antidepressant effects via brain energy restoration',
      'Most researched supplement in history — exceptional safety profile',
    ],
    cautions: [
      'No loading phase needed — 3-5g daily is sufficient for full saturation in 3-4 weeks',
      'Take with carbohydrates for better creatine uptake into muscle cells',
      'Stay well hydrated — creatine draws water into cells (intracellular hydration)',
      'Effects take weeks to fully manifest — be patient and consistent',
      'Creatine is safe for long-term daily use — over 500 studies confirm safety',
    ],
    forSubstances: ['methamphetamine', 'mdma', 'cannabis'],
    stackNotes:
  ...
  },
  {
    ...
    shortName: 'DGL',
    tagline: 'Gut Lining Soother',
    category: 'Gut Healing',
    dosage: '500mg twice daily (before meals)',
    timing: 'Both',
    description:
      'DGL is licorice root that has had glycyrrhizin removed, making it safe for long-term use without the blood pressure-elevating effects of whole licorice. DGL stimulates the production of mucin — the protective coating that lines the stomach and intestinal walls. This mucosal layer is the body\'s first line of defense against stomach acid, digestive enzymes, and ingested toxins. Substance use, particularly methamphetamine and alcohol, severely damages this protective mucosal barrier through vasoconstriction-induced ischemia and direct chemical irritation. DGL also increases blood flow to the intestinal lining, promoting tissue repair and ulcer healing. It has been used clinically for decades to treat peptic ulcers and gastritis.',
    mechanism:
      'Stimulates mucin production by gastric and intestinal mucosal cells, thickening the protective mucosal barrier. Increases secretion of prostaglandins (PGE2, PGI2) that protect the gastric mucosa. Enhances blood flow to the intestinal lining via nitric oxide (NO) pathway. Glycyrrhetinic acid (remaining after deglycyrrhization) has anti-inflammatory and anti-spasmodic properties. Supports the regeneration of damaged intestinal epithelial cells. Protects against NSAID-induced mucosal damage.',
    benefits: [
      'Soothes and protects the gut lining with enhanced mucin production',
      'Encourages the stomach\'s natural protective mucus barrier',
      'Reduces intestinal inflammation and promotes tissue healing',
      'Supports ulcer healing by increasing mucosal blood flow',
      'Protects against NSAID and aspirin damage to the stomach lining',
      'Anti-spasmodic — reduces gut cramping and intestinal spasms',
      'Safe for long-term use (glycyrrhizin removed to prevent blood pressure effects)',
      'Well-tolerated and affordable',
    ],
    cautions: [
      'Take 20-30 minutes before meals for optimal mucosal protection',
      'Do NOT use if you have high blood pressure (DGL has had glycyrrhizin removed, but caution still advised)',
      'Start with 500mg once daily and increase to twice daily',
      'Chewable DGL tablets work best — saliva activates the deglycyrrhized compounds',
      'May interact with certain blood pressure medications — consult doctor if applicable',
    ],
    forSubstances: ['methamphetamine', 'alcohol'],
    stackNotes:
  ...
  },
  {
    ...
    shortName: 'Aloe Vera',
    tagline: 'Digestive Tract Cooler',
    category: 'Gut Healing',
    dosage: '50-100mg daily',
    timing: 'Both',
    description:
      'Aloe Vera has been used medicinally for over 6,000 years across multiple civilizations. The inner leaf gel contains a complex mixture of polysaccharides (acemannan), glycoproteins, enzymes, vitamins, and minerals that provide profound healing benefits for the digestive tract. The mucilaginous gel coats and soothes damaged intestinal lining, reduces inflammation, and accelerates tissue repair. For substance recovery, Aloe Vera is particularly valuable because methamphetamine causes severe intestinal vasoconstriction and ischemic damage, while alcohol directly burns and irritates the mucosal lining. Aloe Vera addresses both types of damage simultaneously. In the Philippines, fresh Aloe Vera grows abundantly and is freely available — making this one of the most accessible gut-healing remedies.',
    mechanism:
      'Acemannan (primary polysaccharide) stimulates macrophage activity and enhances immune response in the gut. Mucilaginous gel forms a physical protective barrier over damaged intestinal mucosa. Contains lectins that have anti-inflammatory properties via COX and LOX pathway inhibition. Glycoproteins accelerate wound healing by stimulating fibroblast proliferation and collagen synthesis. Provides enzymes (amylase, lipase, alkaline phosphatase) that aid digestion. Supports the growth of beneficial bifidobacteria in the gut.',
    benefits: [
      'Cooling and soothing for an inflamed digestive tract',
      'Reduces intestinal inflammation through multiple pathways',
      'Supports gut lining repair and mucosal regeneration',
      'Aids nutrient absorption by coating and protecting the intestinal surface',
      'Gentle laxative effect helps with constipation common in early recovery',
      'Stimulates beneficial gut bacteria (bifidobacteria) growth',
      'Provides natural enzymes that improve digestion',
      'Freely available in the Philippines — grows abundantly in tropical climate',
    ],
    cautions: [
      'Choose inner leaf fillet ONLY — outer leaf contains aloin (strong laxative, can cause cramping)',
      'Start with 50mg (or 1 tbsp fresh gel) and increase gradually',
      'Can be taken with or without food',
      'Fresh aloe vera gel from local markets is excellent and free — just avoid outer leaf skin',
      'Oral aloe may interact with diabetes medications (can lower blood sugar)',
    ],
    forSubstances: ['methamphetamine', 'alcohol'],
    stackNotes:
  ...
  },
  {
    ...
    shortName: 'Zinc Carnosine',
    tagline: 'Intestinal Barrier Defender',
    category: 'Minerals',
    dosage: '75mg twice daily',
    timing: 'Both',
    description:
      'Zinc L-Carnosine is a chelated compound where zinc is bound to the dipeptide carnosine (beta-alanyl-L-histidine). This specific molecular arrangement allows it to adhere directly to the stomach and intestinal lining, providing targeted, prolonged protection at the site of damage. Developed in Japan for the treatment of gastric ulcers (sold under the brand Polaprezinc), zinc carnosine has over 20 years of clinical use and extensive research supporting its efficacy. It is particularly valuable for substance recovery because it combines the gut-healing properties of zinc (which promotes mucosal repair) with carnosine (a powerful antioxidant and anti-glycation agent). The combination addresses multiple aspects of intestinal damage simultaneously: barrier integrity, inflammation, oxidative stress, and tissue regeneration.',
    mechanism:
      'Chelated zinc-carnosine complex adheres to and concentrates at the ulceration site, providing prolonged local activity. Zinc stimulates mucosal cell proliferation and migration for wound healing. Carnosine provides antioxidant protection against ROS and inhibits TNF-alpha mediated inflammation. Stabilizes mast cells (reducing histamine-driven intestinal permeability). Upregulates heat shock proteins (HSP70) that protect gastric mucosal cells from stress damage. Inhibits NF-kB inflammatory signaling pathway.',
    benefits: [
      'Supports intestinal barrier integrity — directly repairs leaky gut',
      'Protects stomach lining with prolonged adherence at damage sites',
      'Enhances mucosal defense through multiple mechanisms',
      'Combines zinc (tissue repair) and carnosine (antioxidant) in one molecule',
      'Reduces gut permeability and prevents endotoxin (LPS) translocation',
      'Clinically proven to treat gastric ulcers — over 20 years of use in Japan',
      'Inhibits inflammatory signaling (NF-kB, TNF-alpha) in the gut',
      'Stabilizes mast cells — reduces histamine-driven gut symptoms',
    ],
    cautions: [
      'Take with meals for optimal absorption and gastric coating',
      'Higher doses (over 150mg) may cause nausea — start with 75mg',
      'Long-term zinc supplementation may require copper supplementation (1-2mg copper daily) to prevent copper deficiency',
      'Allow 4-8 weeks for full gut healing effects — tissue repair takes time',
      'May be less commonly available — order online if not found locally',
    ],
    forSubstances: ['methamphetamine', 'alcohol'],
    stackNotes:
  ...
  },
  {
    ...
    name: 'Quercetin',
    shortName: 'Quercetin',
    tagline: 'Anti-Inflammatory Shield',
    category: 'Antioxidants',
    dosage: '400-500mg daily',
    timing: 'AM',
    description:
      'Quercetin is a flavonoid polyphenol found naturally in onions, apples, berries, and capers. It is one of the most potent natural anti-inflammatory compounds studied, with the ability to inhibit multiple inflammatory pathways simultaneously. Quercetin is particularly valuable for substance recovery because it crosses the blood-brain barrier and reduces neuroinflammation while simultaneously enhancing gut healing. It stabilizes mast cells (reducing histamine-driven gut permeability), inhibits NF-kB and COX-2 inflammatory pathways, and enhances the efficacy of L-Glutamine for intestinal repair. Quercetin also supports cardiovascular health and has antiviral properties. The Phytosome form (bound to phosphatidylcholine) has 50x better absorption than regular quercetin.',
    mechanism:
      'Inhibits NF-kB (master inflammatory transcription factor), COX-2, and LOX inflammatory enzymes. Stabilizes mast cell membranes, preventing histamine and inflammatory cytokine release. Enhances L-Glutamine gut healing by reducing inflammatory cytokines that interfere with tight junction repair. Crosses blood-brain barrier and reduces neuroinflammation. Modulates Nrf2 antioxidant pathway. Quercetin Phytosome form binds to phosphatidylcholine for 50x enhanced bioavailability via liposomal absorption.',
    benefits: [
      'Potent antioxidant and anti-inflammatory — addresses multiple inflammatory pathways',
      'Inhibits NF-kB, COX-2, and LOX inflammatory cascades',
      'Enhances L-Glutamine gut healing by reducing inflammatory interference',
      'Supports cardiovascular health and reduces blood pressure',
      'Reduces histamine response and stabilizes mast cells',
      'Crosses blood-brain barrier — reduces neuroinflammation',
      'Supports mitochondrial function and reduces oxidative stress',
      'Has natural antiviral and immune-modulating properties',
    ],
    cautions: [
      'Take with meals — better absorption with dietary fat',
      'Start with 400mg and increase to 500mg if well-tolerated',
      'May interact with certain medications (antibiotics like quinolones, blood thinners)',
      'Quercetin Phytosome form recommended — 50x better absorption than regular quercetin',
      'Can enhance the effects of blood pressure medications — monitor if applicable',
    ],
    forSubstances: ['methamphetamine', 'alcohol'],
    stackNotes:
  ...
  {
    id: 'dlpa',
    name: 'DLPA (D,L-Phenylalanine)',
    shortName: 'DLPA',
    tagline: 'Endorphin Rebuilder',
    category: 'Amino Acids',
    dosage: '500-750mg on empty stomach',
    timing: 'AM',
    description:
      'DLPA is a combination of two forms of the essential amino acid phenylalanine: L-phenylalanine (which converts to L-tyrosine → L-DOPA → dopamine) and D-phenylalanine (which inhibits the enzyme enkephalinase that breaks down endorphins, the body\'s natural painkillers). This dual action makes DLPA uniquely valuable for substance recovery — it simultaneously supports dopamine synthesis AND preserves the brain\'s natural endorphin system, which is severely depleted by opioid, alcohol, and stimulant use. DLPA has been clinically studied for chronic pain management, depression, and addiction recovery. It addresses both the dopamine deficiency (motivation, drive, reward) and endorphin deficiency (pain sensitivity, emotional numbness) that characterize post-acute withdrawal syndrome (PAWS).',
    mechanism:
      'L-phenylalanine converts to L-tyrosine via phenylalanine hydroxylase, providing a precursor for dopamine, norepinephrine, and epinephrine synthesis. D-phenylalanine inhibits carboxypeptidase A (enkephalinase), the enzyme that degrades endorphins and enkephalins, effectively increasing the brain\'s natural opioid peptide activity. Together, the D and L forms provide dual-pathway support for both the dopaminergic (reward/motivation) and endorphinergic (pain/mood) systems.',
    benefits: [
      'Rebuilds natural endorphin production for pain management and emotional resilience',
      'Supports dopamine synthesis via the L-phenylalanine → tyrosine pathway',
      'Reduces emotional and physical pain sensitivity during withdrawal',
      'Improves mood and reduces symptoms of anhedonia (emotional numbness)',
      'Reduces cravings by supporting both dopamine and endorphin pathways',
      'Non-addictive alternative to pain management approaches',
      'Supports stress resilience via norepinephrine production',
      'Addresses both motivational (dopamine) and emotional (endorphin) recovery',
    ],
    cautions: [
      'Take on empty stomach — amino acids compete with dietary proteins for absorption',
      'Do NOT use with MAOIs or L-DOPA medications — dangerous interactions',
      'May cause mild anxiety or restlessness in sensitive individuals — start with 500mg',
      'Start with 500mg and increase to 750mg only if well-tolerated',
      'Do NOT combine with 5-HTP — they compete for the same amino acid transporter',
    ],
    forSubstances: ['methamphetamine', 'heroin', 'alcohol'],
    stackNotes:
  ...
  {
    id: 'butyrate',
    name: 'Butyrate (Short-Chain Fatty Acid)',
    shortName: 'Butyrate',
    tagline: 'Gut Cell Fuel',
    category: 'Gut Healing',
    dosage: '300-500mg daily',
    timing: 'Both',
    description:
      'Butyrate is a short-chain fatty acid (SCFA) that serves as the primary energy source for colonocytes (cells lining the large intestine). It is naturally produced by beneficial gut bacteria when they ferment dietary fiber and prebiotics. In a healthy gut, butyrate constitutes about 70% of the energy used by colonocytes. During substance use, the gut microbiome is devastated, leading to dramatically reduced butyrate production. This starves the intestinal cells, weakens the gut barrier, and increases intestinal permeability ("leaky gut"). Supplementing with butyrate directly addresses this energy deficit, providing the fuel that intestinal cells need to repair themselves. Butyrate also has powerful anti-inflammatory and gene-regulatory properties, modulating over 100 genes related to gut barrier integrity and immune function.',
    mechanism:
      'Directly fuels colonocytes via beta-oxidation, providing up to 70% of their energy needs. Upregulates tight junction proteins (claudin-1, occludin, ZO-1) that seal the intestinal barrier. Inhibits histone deacetylases (HDACs), epigenetically activating anti-inflammatory genes. Suppresses NF-kB inflammatory signaling in intestinal immune cells. Enhances regulatory T-cell (Treg) function, promoting immune tolerance. Stimulates mucin production for the protective gut lining. The "end product" of the synbiotic approach — prebiotics feed probiotics, which produce butyrate.',
    benefits: [
      'Directly fuels intestinal cells — provides the energy they need to repair and regenerate',
      'Heals gut lining by upregulating tight junction proteins that seal the intestinal barrier',
      'Reduces intestinal permeability (leaky gut) and prevents endotoxin translocation',
      'Produced naturally by probiotic fermentation of prebiotics — the end product of synbiotic nutrition',
      'Reduces inflammation through HDAC inhibition and NF-kB suppression',
      'Supports immune function by enhancing regulatory T-cell activity',
      'Stimulates mucin production for protective gut coating',
      'Modulates gene expression for long-term gut health improvements',
    ],
    cautions: [
      'Start with 300mg and increase gradually to assess tolerance',
      'May cause mild bloating initially (die-off effect as gut bacteria adjust)',
      'Calcium butyrate and sodium butyrate forms are both available — calcium form preferred',
      'Take with meals for better tolerance',
      'Best used as part of a comprehensive gut healing protocol alongside probiotics and prebiotics',
    ],
    forSubstances: ['methamphetamine', 'alcohol'],
    stackNotes:
